...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sigmabit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"n1.sigmabit.org", "192.99.55.242"},
    {"n2.sigmabit.org", "167.114.103.43"},
    {"n3.sigmabit.org", "149.56.134.171"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"t1.sigmabit.org", "192.99.55.242"},
    {"t2.sigmabit.org", "167.114.103.43"},
    {"t3.sigmabit.org", "149.56.134.171"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sigmabit is probably already running."), addrBind.ToString().c_str());
        else
